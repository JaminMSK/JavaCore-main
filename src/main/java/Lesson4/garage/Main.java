...
import Lesson4.ArrayListExamples;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Car> carArrayList = new ArrayList<>(Arrays.asList(new Car("Рено", 100, 12),
                new Car("BMW",150, 15), new Car("Lada",30, 9)));
